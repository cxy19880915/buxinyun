...
#define ADKEY_V_6 		0x17b//((ADC0_13 + ADC0_00)/2)//up 0.7
#define ADKEY_V_7 		0x103//((ADC0_03 + ADC0_03)/2)//down 0.4
#define ADKEY_V_8 		0xAC//((ADC0_01 + ADC0_01)/2)//ok 0.2
#define ADKEY_V_9 		0x50//((ADC0_01 + ADC0_00)/2)//menu/mode 0.1
