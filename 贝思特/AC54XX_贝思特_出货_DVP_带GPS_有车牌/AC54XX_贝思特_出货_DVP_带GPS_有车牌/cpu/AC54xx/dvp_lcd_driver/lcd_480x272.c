...
REGISTER_LCD_DEVICE(lcd_480x272_dev) = {
    .info = {
        .test_mode 	     = false,
        .color           = 0x00FF00,
        .xres 			 = LCD_DEV_WIDTH,
    ...
    .timing = {
#ifdef INTERPOLATION_MODE_TEST
        .hori_interval 		= 625,//12000000/60/288,//
        .hori_sync_clk 		= 1,
        .hori_start_clk 	= 40,
...
#else
        .hori_interval 		= 625,//12500000/60/288,//
        .hori_sync_clk 		= 1,
        .hori_start_clk 	= 40,
        .hori_pixel_width 	= 480,
