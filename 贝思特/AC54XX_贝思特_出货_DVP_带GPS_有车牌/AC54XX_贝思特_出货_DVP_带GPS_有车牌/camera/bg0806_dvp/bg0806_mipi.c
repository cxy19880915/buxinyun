...
#define VBLANK_30FPS    0x1d//0x27 // 0x25
#define VBLANK_25FPS    0xfe
#define VBLANK_20FPS    0x250
#define VBLANK_16FPS    0x3f6
#define VBLANK_10FPS    0x8e7
#define VBLANK_5FPS     0x1616

#define MAX_EXP_LINE_30FPS  (1125-2)
#define MAX_EXP_LINE_25FPS  (1350-2)
#define MAX_EXP_LINE_20FPS  (1687-2)
#define MAX_EXP_LINE_16FPS  (2109-2)
#define MAX_EXP_LINE_10FPS  (3375-2)
#define MAX_EXP_LINE_5FPS   (6750-2)
...
static void cal_texp_mck(u32 exp_time, u32 *texp, u32 *mck)
{
	...
	if (exp_time > 100000) {
		gVblank = VBLANK_5FPS;
		gExplineMax = MAX_EXP_LINE_5FPS;

	} else if (exp_time > 80000) {
        gVblank = VBLANK_10FPS;
        gExplineMax = MAX_EXP_LINE_10FPS;
