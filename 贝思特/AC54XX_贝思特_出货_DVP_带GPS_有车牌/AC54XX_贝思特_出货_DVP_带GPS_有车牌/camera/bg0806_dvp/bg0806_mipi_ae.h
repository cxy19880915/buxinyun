...
#define AE_DIVER_H                  12
#define AE_DIVER_L                  12

#define AE_RATIO_MAX_H              2048    //base=1024
#define AE_RATIO_MAX_L              512     //base=1024

#define AE_RATIO_MAX2_H             1066//1102    //base=1024
#define AE_RATIO_MAX2_L             996//960    //base=1024

#define AE_RATIO_SLOPE              256     //base=1024

#define AE_EXPLINE_TH               0

#define AE_INIT_WEIGHT_TYPE         AE_WIN_WEIGHT_MULTI
