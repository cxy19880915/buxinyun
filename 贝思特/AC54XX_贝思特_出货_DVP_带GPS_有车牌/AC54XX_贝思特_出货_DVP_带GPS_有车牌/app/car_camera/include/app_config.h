...
#define CONFIG_BOARD_MIPI_TOUCH_V1_DVP
...
#elif(LCD_TYPE == LCD_DSI_VDO_4LANE_800x480)
#define LCD_NAME      "mipi_2lane_mipi"
#elif(LCD_TYPE == LCD_DSI_DCS_4LANE_1080P)
#define LCD_NAME      "mipi_4lane_1080p"
#elif(LCD_TYPE == LCD_DSI_VDO_4LANE_1920x1080)
#define LCD_NAME      "mipi_4lane_1080"
#elif(LCD_TYPE == LCD_DSI_VDO_4LANE_1280x400)
#define LCD_NAME      "mipi_4lane_1280x400"
#elif(LCD_TYPE == LCD_DSI_VDO_4LANE_1280x400_ZT)
#define LCD_NAME      "mipi_4lane_1280x400_zt"
#elif(LCD_TYPE == LCD_DSI_VDO_4LANE_1280x480_WT686)
#define LCD_NAME      "mipi_4lane_1280x480_WT"
#elif(LCD_TYPE == LCD_DSI_VDO_4LANE_1280x480_WT686_1)
#define LCD_NAME      "mipi_4lane_1280x480_WT_1"
...
extern unsigned char get_accin_det_status();
extern void accin_det_init();	
extern unsigned char PWR_CTL(unsigned char on_off);
extern void ui_lcd_light_off(void);
extern void ui_lcd_light_on(void);
extern void usb_off_light_low(void);
extern void dog_det_init();
unsigned char get_dog_status();
extern void play_dog_voice_hander();
extern void send_key_long_msg();
extern int unmount(const char *path);
extern void rtc_get_time();
extern volatile int sys_in_lane_flag;

extern volatile int dec_main_flag;
