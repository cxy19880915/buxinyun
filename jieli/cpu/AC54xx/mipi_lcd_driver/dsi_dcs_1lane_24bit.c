...
#if (LCD_TYPE == LCD_DSI_DCS_1LANE_24BIT)

const static u8 init_cmd_list[] = {
    _W, DELAY(20), SIZE(1), 0x01, //sw reset
    _W, DELAY(20), SIZE(1), 0x11, //exit sleep mode
    _R, DELAY(1), SIZE(1), 0x0a,
    _W, DELAY(1), SIZE(2), 0x3a, 0x77, //set pixel format 16bit
    _W, DELAY(1), SIZE(2), 0x36, 0x01, //set address mode
    _W, DELAY(1), SIZE(2), 0x26, 0x01, //set gamma curve
    _W, DELAY(1), SIZE(2), 0x51, 0xca,
    _W, DELAY(1), SIZE(2), 0x53, 0x2c,
    _W, DELAY(1), SIZE(9), 0x58, 0x7f, 0x7f, 0x7f, 0x7f, 0x7f, 0x7f, 0x7f, 0x7f,
    _W, DELAY(1), SIZE(10), 0xf9, 0x03, 0x03, 0x03, 0x04, 0x04, 0x04, 0x30, 0x30, 0x30,
    _W, DELAY(1), SIZE(1), 0x29, //display on
    _R, DELAY(1), SIZE(1), 0x0a,
...
REGISTER_LCD_DEVICE_DRIVE(dev)  = {
    .enable = IF_ENABLE(LCD_DSI_DCS_1LANE_24BIT),
    .logo = "mipi_1lane_24bit",
    .type = LCD_MIPI,
    .init = dsi_init,
    .dev  = &mipi_dev_t,
