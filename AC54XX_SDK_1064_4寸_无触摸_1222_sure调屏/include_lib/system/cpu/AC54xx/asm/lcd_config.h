...
#define LCD_DSI_VDO_4LANE_800x480                          (MIPI_BASE_NUM+12)  //?????
#define LCD_MIPI_2LANE_856x480					(MIPI_BASE_NUM+13)
#define  LCD_DSI_VDO_2LANE_854x480                             (MIPI_BASE_NUM+14)  //Сī

#ifdef CONFIG_TOUCH_UI_ENABLE
//#define LCD_TYPE   LCD_DSI_VDO_2LANE_854x480
#define LCD_TYPE	LCD_DSI_VDO_4LANE_800x480
#else
//#define LCD_TYPE     LCD_DSI_VDO_2LANE_854x480
#define LCD_TYPE     LCD_DSI_VDO_4LANE_800x480
#endif
...
/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~beautiful line~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
#if (LCD_TYPE == LCD_HX8369A_MCU)||(LCD_TYPE == LCD_HX8369A_SPI_RGB)||(LCD_TYPE ==LCD_DSI_VDO_4LANE_800x480)
...
/*插值*/
#define LCD_DEV_WIDTH	864//1296
#define LCD_DEV_HIGHT	224//336
#endif



#if (LCD_TYPE == LCD_DSI_VDO_2LANE_854x480)||(LCD_TYPE == LCD_MIPI_2LANE_856x480)
#define LCD_DEV_WIDTH	800
#define LCD_DEV_HIGHT	480
#endif
/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~beautiful line~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
//extern void ui_lcd_light_on(void);
//extern void ui_lcd_light_on_low(void);
