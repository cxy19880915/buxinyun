...
static const struct camera_platform_data camera0_data = {
    .xclk_gpio      = IO_PORTB_11,//IO_PORTA_14,
...
#define ADC0_13   (0x3ff*13/33) //0x193  17d 381
#define ADC0_07   (0x3ff*07/33) //0x136
#define ADC0_05   (0x3ff*06/33) //0x136
#define ADC0_03   (0x3ff*03/33) //0xD9
#define ADC0_02   (0x3ff*02/33) //0xD9
#define ADC0_01   (0x3ff*01/33) //0x7C    A  10
#define ADC0_00   (0)
...
#define ADKEY_V_6 		((ADC0_13 + ADC0_02)/2)//up 0.7  BE  190
#define ADKEY_V_7 		((ADC0_05 + ADC0_07)/2)//down 0.4
#define ADKEY_V_8 		((ADC0_03 + ADC0_05)/2)//ok 0.2
#define ADKEY_V_9 		((ADC0_01 + ADC0_00)/2)//menu/mode 0.1  A  10
...
ADKEY_PLATFORM_DATA_BEGIN(adkey_data)
	...
	.table 	= {
		...
		.key_value = {
			...
			KEY_DOWN,
			KEY_OK,
			KEY_MENU,//long KEY_MENU,// kick KEY_MODE
			KEY_MODE,//,
		},
	},
