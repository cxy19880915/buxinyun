...
#define ADKEY_V_5 		((ADC0_02 + ADC0_13)/2)
#define ADKEY_V_6 		((ADC0_07 + ADC0_07)/2)//up 0.7  BE  190
#define ADKEY_V_7 		((ADC0_07 + ADC0_05)/2)//down 0.4
#define ADKEY_V_8 		((ADC0_02 + ADC0_05)/2)//ok 0.2
...
ADKEY_PLATFORM_DATA_BEGIN(adkey_data)
	...
	.table 	= {
		...
		.key_value = {
			...
			NO_KEY,
			NO_KEY,
			KEY_DOWN,//long KEY_MENU,// kick KEY_MODE
			KEY_UP,//,
		},
	},
...
SW_TOUCH_PANEL_PLATFORM_DATA_BEGIN(touch_panel_data)
    .enable         = 1,
    .iic_dev        = "iic2",
    .rst_pin        = IO_PORTG_07,//IO_PORTG_08
    .int_pin        = IO_PORTG_06,
    ._MAX_POINT     = 1,
    ._MAX_X         = 1280,
    ._MAX_Y         = 720,    
