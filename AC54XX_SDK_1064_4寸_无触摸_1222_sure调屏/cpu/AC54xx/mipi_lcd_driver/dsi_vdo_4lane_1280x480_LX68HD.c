...
const static u8 init_cmd_list[] = {
    _W, DELAY(0), SIZE(3), 0xF0, 0x5A,0x5A,
    _W, DELAY(0), SIZE(3), 0xF1, 0xA5,0xA5,
    _W, DELAY(0), SIZE(3), 0xF0, 0xB4,0x4B,
    _W, DELAY(0), SIZE(3), 0xB6, 0x3C,0x3C,
    _W, DELAY(0), SIZE(23), 0xB3, 0x1D,0x08,0x1E,0x1F,0x10,0x12,0x0C,0x0E,0x00,0x1C,0x04,0x06,0x03,0x03,0x03,0x03,0x03,0x03,0x03,0x03,0x03,0x03,
    _W, DELAY(0), SIZE(23), 0xB4, 0x1D,0x08,0x1E,0x1F,0x11,0x13,0x0D,0x0F,0x00,0x1C,0x05,0x07,0x03,0x03,0x03,0x03,0x03,0x03,0x03,0x03,0x03,0x03,
    _W, DELAY(0), SIZE(14),0xB0,0x76,0x54,0xBB,0xBB,0x33,0x33,0x33,0x33,0x22,0x02,0x6E,0x02,0x0E,
    _W, DELAY(0), SIZE(10),0xB1, 0x53,0xA0,0x00,0x60,0x22,0x02,0x6E,0x02,0x5F,

    _W, DELAY(0), SIZE(11),0xB2,0x37,0x09,0x08,0x89,0x08,0x00,0x22,0x00,0x44,0xD9,
    _W, DELAY(0), SIZE(7),0xBD,0x4E,0x0E,0x41,0x41,0x11,0x1E,
    _W, DELAY(0), SIZE(18),0xB7,0x01,0x01,0x09,0x11,0x0D,0x15,0x19,0x0D,0x21,0x1D,0x00,0x00,0x20,0x00,0x02,0xFF,0x3C,
    _W, DELAY(0), SIZE(6),0xB8,0x23,0x01,0x30,0x34,0x53,
    _W, DELAY(0), SIZE(3),0xBA,0x13,0x63,
    _W, DELAY(0), SIZE(7),0xC1,0x0F,0x0E,0x01,0x36,0x3A,0x08,
    _W, DELAY(0), SIZE(3),0xC2,0x11,0x40,
    _W, DELAY(0), SIZE(4),0xC3,0x22,0x31,0x04,
    _W, DELAY(0), SIZE(6),0xC7,0x05,0x23,0x6B,0x41,0x00,
    _W, DELAY(0), SIZE(39),0xC8,0x7C,0x63,0x54,0x48,0x47,0x39,0x3F,0x29,0x43,0x41,0x41,0x61,0x53,0x5F,0x53,0x50,0x44,0x30,0x06,0x7C,0x63,0x54,0x48,0x47,0x39,0x3F,0x29,0x43,0x41,0x41,0x61,0x53,0x5F,0x53,0x50,0x44,0x30,0x06,

    _W, DELAY(0), SIZE(2),0x35,0x01,
    _W, DELAY(0), SIZE(2),0x36,0x14,

    _W, DELAY(120), SIZE(2),0x11, 0x00,
