...
#define LCD_SDA_OUT()   gpio_direction_output(IO_PORTG_15,0);gpio_set_pull_up(IO_PORTG_15,1)
#define LCD_SDA_IN()    gpio_direction_input(IO_PORTG_15)
#define LCD_SDA_H()     gpio_direction_output(IO_PORTG_15,1)
#define LCD_SDA_L()     gpio_direction_output(IO_PORTG_15,0)
#define LCD_SDA_R()     gpio_read(IO_PORTG_15)


#define LCD_SCL_OUT()   gpio_direction_output(IO_PORTG_14,0)
#define LCD_SCL_H()     gpio_direction_output(IO_PORTG_14,1)
#define LCD_SCL_L()     gpio_direction_output(IO_PORTG_14,0)
...
REGISTER_LCD_DEVICE(lcd_ili8961c_dev) = {
    ...
    .timing = {
        ...
        .hori_interval 		=   1360,//1560/4,
        .hori_sync_clk 		=   2,
        .hori_start_clk 	=   17,//240/4,
...
void lcd_rotate(u8 on_off)
{
	if(on_off)	
	{
		spi_write_cmd(0x36);
		spi_write_dat(0x08); //08  c8    
	}
	else
	{
		spi_write_cmd(0x36);
