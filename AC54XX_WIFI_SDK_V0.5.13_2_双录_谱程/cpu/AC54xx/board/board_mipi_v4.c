...
#define ADKEY_V_5 		((ADC0_20 + ADC0_13)/2)//up 1.9
#define ADKEY_V_6 		((ADC0_17 + ADC0_12)/2)
#define ADKEY_V_7 		((ADC0_17 + ADC0_07)/2)//down 1.4
#define ADKEY_V_8 		((ADC0_07 + ADC0_02)/2)//ok 0.8
#define ADKEY_V_9 		((ADC0_02 + ADC0_02)/2)//menu/mode 0.1
...
WIFI_PLATFORM_DATA_BEGIN(wifi_data)
	.module = RTL8189E,
	.sdio_parm = SDIO_GRP_2 | SDIO_PORT_1 | SDIO_4_BIT_DATA |SDIO_DATA1_IRQ| SDIO_CLOCK_20M,
