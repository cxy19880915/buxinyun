...
static void  uart_port_remap_func(void)
{
    ...
    IOMC1 |=    (0x3 << 8);
    gpio_direction_output(IO_PORTH_11, 0);//重定向脚为IO_PORTA_08
    gpio_set_pull_up(IO_PORTH_11, 1);
    gpio_set_pull_down(IO_PORTH_11, 1);
    gpio_set_die(IO_PORTH_11, 0);

}
UART3_PLATFORM_DATA_BEGIN(uart0_data)
	.baudrate = 460800,
...
#define SD1_DET_IO  -1//IO_PORTA_10
...
static const struct camera_platform_data camera0_data = {
	.xclk_gpio      = IO_PORTG_10,
	.reset_gpio     = IO_PORTG_12,
	.pwdn_gpio      = IO_PORTG_13,
    .power_value    = 1,
...
WIFI_PLATFORM_DATA_BEGIN(wifi_data)
	.module = RTL8189E,
	.sdio_parm = SDIO_GRP_1 | SDIO_PORT_2 | SDIO_4_BIT_DATA /*|SDIO_DATA1_IRQ*/ | SDIO_CLOCK_40M,
