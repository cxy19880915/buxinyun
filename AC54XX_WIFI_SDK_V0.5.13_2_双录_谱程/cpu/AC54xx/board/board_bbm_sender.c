...
/*
 * spi2接rtc6763/a7130/pan2418/a7196
 */
...
void debug_uart_init()
{
    ...
    if (uart0_data.tx_pin == IO_PORTG_12) {
        IOMC1 &= ~(0x0f << 8);
        gpio_direction_output(IO_PORTG_12, 0);
        gpio_set_pull_up(IO_PORTG_12, 1);
        gpio_set_pull_down(IO_PORTG_12, 1);
        gpio_set_die(IO_PORTG_12, 0);
    }
    IOMC3 &= ~(BIT(15) | BIT(14)); //解除占据SD2的时钟与信号线
    IOMC0 &= ~(BIT(20) | BIT(21));
    IOMC0 &= ~(BIT(5) | BIT(4));
