...
#define     IMAGE_AUX_BUF_SIZE        HD_QUALITY//HIG_QUALITY //LOW_QUALITY
#define     IMAGE_THUMB_BUF_SIZE      (64 * 1024)

#define PHOTO_CAMERA_NUM        5

#define JPG_THUMBNAILS_ENABLE   //缩略图功能
#define PHOTO_STICKER_ENABLE    0//大头贴功能，默认关闭
