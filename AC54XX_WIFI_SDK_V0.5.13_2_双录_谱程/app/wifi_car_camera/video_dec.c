...
static int video_dec_start(void *p)
{
    ...
    /* __this->req.dec.left 	= (LCD_DEV_WIDTH - __this->req.dec.width) / 2; */
    /* __this->req.dec.top 	= (LCD_DEV_HIGHT - __this->req.dec.height) / 2; */

    /*截取中间区域全屏显示*/
    __this->req.dec.width 	= 1600;
    __this->req.dec.height 	= 912;
    __this->req.dec.border_left = __this->req.dec.border_right = (__this->req.dec.width - LCD_DEV_WIDTH) / 2;
    __this->req.dec.border_top = __this->req.dec.border_bottom	= (__this->req.dec.height - LCD_DEV_HIGHT) / 2;
#else
    __this->req.dec.left 	= 0;
    __this->req.dec.top 	= 0;
    __this->req.dec.width 	= 320;
    __this->req.dec.height 	= 240;
    ...
    __this->req.dec.audio_p.volume = -1;
...
int dec_open_file()
{
    ...
    __this->req.dec.left 	= 0;
    __this->req.dec.top 	= 0;
    __this->req.dec.width 	= 320;// 0;
    __this->req.dec.height 	= 240;// 0;
