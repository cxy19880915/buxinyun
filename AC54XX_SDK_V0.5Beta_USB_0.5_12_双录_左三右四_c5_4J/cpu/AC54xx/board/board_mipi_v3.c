...
LCD_PLATFORM_DATA_BEGIN(lcd_data)
	.interface = LCD_DVP_MCU,
	.lcd_io = {
        .backlight = IO_PORTH_06,
        .backlight_value = 1,
		.lcd_reset = -1,//IO_PORTH_01,
        .lcd_cs    = -1,
        .lcd_rs    = -1,
        .lcd_spi_ck= -1,
        .lcd_spi_di= -1,
...
#define ADKEY_V_5 		0x1b0//((ADC0_17 + ADC0_13)/2)
#define ADKEY_V_6 		0x164//((ADC0_13 + ADC0_00)/2)//up 0.7
#define ADKEY_V_7 		0x10e//((ADC0_03 + ADC0_03)/2)//down 0.4
#define ADKEY_V_8 		0xb5//((ADC0_01 + ADC0_01)/2)//ok 0.2
#define ADKEY_V_9 		0x3c//((ADC0_01 + ADC0_00)/2)//menu/mode 0.1
...
#define ACC_WKUP_IO 	IO_PORT_PR_02
...
void debug_uart_init()
{
    ...
    if (uart0_data.tx_pin == IO_PORTH_10) {
        IOMC1 &= ~(0x0f << 8);
