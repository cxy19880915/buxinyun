...
static const struct camera_platform_data camera0_data = {
	...
	.reset_gpio     = IO_PORTB_07,
    .online_detect  = NULL,
	.pwdn_gpio      = IO_PORTB_06,
    .power_value    = 1,
...
UVC_PLATFORM_DATA_BEGIN(v4_uvc_data)
    .width = 1280,
    .height = 720,
    .fps = 25,
    .mem_size = 1 * 1024 * 1024,
...
static const struct video_subdevice_data video4_subdev_data[] = {
    { VIDEO_TAG_UVC, (void *)&v4_uvc_data },
    { VIDEO_TAG_MASS, (void *)&v4_uvc_data },
};
...
REGISTER_DEVICES(device_table) = {
    ...
    { "usb_cam0",  &usb_cam_dev_ops, NULL },
    { "usb_cam1",  &usb_cam_dev_ops, NULL },
